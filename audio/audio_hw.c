                                     ...
                                     int32_t delay_us)
{
    ...
    uint32_t ed = AEC_PARAM_ECHO_DELAY ; memset(&param->data, &ed, sizeof(uint32_t));    //*(uint32_t *)param->data = AEC_PARAM_ECHO_DELAY;
    memset(&param->data + sizeof(int32_t), &delay_us, sizeof(int32_t)); //*((int32_t *)param->data + 1) = delay_us;
